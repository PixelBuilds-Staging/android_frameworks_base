...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangePixel5.put("FINGERPRINT", "google/barbet/barbet:14/AP1A.240305.019.A1/11445699:user/release-keys");
        propsToChangePixel5.put("ID", "AP1A.240305.019.A1");
