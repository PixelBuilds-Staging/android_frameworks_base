package com.pb.android.systemui;
...
import com.pb.android.systemui.ambient.AmbientIndicationContainer;
import com.pb.android.systemui.ambient.AmbientIndicationService;
...
@SysUISingleton
public class PBServices extends VendorServices {
    ...
    @Inject
    public PBServices(Context context, AlarmManager alarmManager, CentralSurfaces centralSurfaces) {
        super(context);
